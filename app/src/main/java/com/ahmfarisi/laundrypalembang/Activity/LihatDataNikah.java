...
public class LihatDataNikah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lihat_data_nikah);
...
//                startActivity(new Intent(LihatDataNikah.this, TambahActivity.class));
//            }
//        });
    }
    ...
    public void retrieveData(){
        ...
        tampilData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                ...
                adData = new AdapterData(LihatDataNikah.this, listData);
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                Toast.makeText(LihatDataNikah.this, "Gagal Menghubungi Server : "+t.getMessage(), Toast.LENGTH_SHORT).show();
